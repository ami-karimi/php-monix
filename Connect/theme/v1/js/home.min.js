    ...
    function(e) {
        e.extend(e.ui.tabs.prototype, {
            ...
            rotate: function(e, i) {
                var o = this,
                    n = this.options;
                (e > 1 || null === o.rotationDelay) && void 0 !== e && (o.rotationDelay = e), void 0 !== i && (o.continuing = i);
                var s = o._rotate || (o._rotate = function(t) {
                        clearTimeout(o.rotation), o.rotation = setTimeout(function() {
                            var t = n.selected;
                            o.select(++t < o.anchors.length ? t : 0)
                        }, e), t && t.stopPropagation()
                    }),
                    a = o._unrotate || (o._unrotate = i ? function(e) {
                        t = n.selected, s()
                    } : function(t) {
                        t.clientX && o.rotate(null)
                    });
                return e ? (this.element.bind("tabsshow", s), this.anchors.bind(n.event + ".tabs", a), s()) : (clearTimeout(o.rotation), this.element.unbind("tabsshow", s), this.anchors.unbind(n.event + ".tabs", a), delete this._rotate, delete this._unrotate), 1 === e && (e = o.rotationDelay), this
            },
            pause: function() {
                var t = this;
                this.options;
            ...
            unpause: function() {
                var t = this;
                this.options;
                t.rotate(1, t.continuing)
            }
        })
    }(jQuery);

function show_tab(e) {
    var a = $("[data-id=" + e + "]").parent().attr("class");
    "current" !== a && ($(".tab-header ol li").removeClass("current"), $("[data-id=" + e + "]").parent().addClass("current"), $(".tab-content section").removeClass("active"), $("#" + e).addClass("active"))
}


function login_send() {
    var e = $("[name=username]").val(),
        a = $("[name=password]").val();
    if ("" !== e && "" !== a) {
        $(".btn-login").text("کمی صبر کنید..."), $(".btn-login").prop("disabled", !0);
        var t = document.getElementById("login_input"),
            s = new FormData(t);
        return $.ajax({
            url: "?ajax=login_user",
            data: s,
            ...
            type: "POST",
            success: function(e) {
                $(".btn-login").text("ورود به ناحیه کاربری"), $(".btn-login").prop("disabled", !1);
                var a = $.parseJSON(e),
                    t = $(".result_login"),
                    s = '<div class="alert alert-danger">نام  کاربري و يا کلمه عبور صحيح نميباشد</div>',
                    n = '<div class="alert alert-success">با موفقيت وارد شده ايد اکنون به پنل  خود هدايت ميشويد ...</div>',
                    i = '<div class="alert alert-warning">نام کاربري شما از  پنل  مديريت غير فعال شده است لطفا با پشتيباني  تماس حاصل فرماييد</div>';
                "0" == a.state_login && t.html(s), "1" == a.state_login && (t.html(n), window.location = "/"), "2" == a.state_login && t.html(i)
            }
        }), !1
    }
}
...
function hide_show_massage() {
    $(".alert-tk").fadeOut(), setTimeout(remove_show_massage, 1e3)
}

function show_massage(e, a) {
    "danger" == a && $("body").append('<div class="alert-tk danger"><div onclick="hide_show_massage();" class="close-btn"><i class="fa fa-times" aria-hidden="true"></i></div><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><p>' + e + "</p></div>"), "success" == a && $("body").append('<div class="alert-tk success"><div onclick="hide_show_massage();" class="close-btn"><i class="fa fa-times" aria-hidden="true"></i></div><i class="fa fa-check" aria-hidden="true"></i><p>' + e + "</p></div>"), setTimeout(hide_show_massage, 3e3)
}

function send_tikets() {
    var e = $("[name=f1]").val(),
        a = $("[name=f3]").val(),
        t = $("[name=f4]").val(),
        s = $("#file_1").val();
    if ("" !== s) var n = s.replace(/^.*\./, ""),
        i = $("#file_1")[0].files[0].size;
    var r = "1";
    0 > a && a > 3 && (show_massage("اشتباه در  اولویت بندی", "danger"), r = "0"), "" == t && (show_massage("متن پیام را فراموش کرده اید", "danger"), r = "0"), "" == e && (show_massage("موضوع درخواست را فراموش  کرده اید", "danger"), r = "0"), "" !== s && (n = n == s ? "" : n.toLowerCase(), "zip" !== n && (show_massage("تنها  پسوند .zip مجاز به بارگذاری میباشد", "danger"), r = "0"), i > 1048576 && (show_massage("حجم فایل نباید بیشتر از 1 مگابایت باشد", "danger"), r = "0")), "0" !== r && $("#form-req").submit()
}

function download_file(e, a) {
    var t = $("#file-" + e).text();
    $("#file-" + e).html('<i class="fa fa-1x fa-circle-o-notch fa-spin fa-fw margin-bottom"></i> لطفا کمی صبر نمایید...'), $.post("/?ajax=download_file&id_file=" + parseFloat(e), {
        id_file: parseFloat(e),
        filename_s: a
    }, function(a) {
        window.location = a, $("#file-" + e).html(t)
    })
}
...
function send_new_massage() {
    var e = $("[name=f1]").val(),
        a = $("#file_1").val();
    if ("" !== a) var t = a.replace(/^.*\./, ""),
        s = $("#file_1")[0].files[0].size;
    var n = "1";
    if ("" == e && (show_massage("متن پاسخ را فراموش  نموده اید !", "danger"), n = "0"), "" !== a && (t = t == a ? "" : t.toLowerCase(), "zip" !== t && (show_massage("تنها  پسوند .zip مجاز به بارگذاری میباشد", "danger"), n = "0"), s > 1048576 && (show_massage("حجم فایل نباید بیشتر از 1 مگابایت باشد", "danger"), n = "0")), "0" !== n) {
        $(".btn-send-message").prop("disabled", !0), $(".btn-send-message").html('<i class="fa fa-1x fa-circle-o-notch fa-spin fa-fw margin-bottom"></i> لطفا کمی صبر نمایید...');
        var i = document.getElementById("message_form"),
            r = new FormData(i);
        return $.ajax({
            url: "/?ajax=send_massage",
            data: r,
            cache: !1,
            processData: !1,
            contentType: !1,
            type: "POST",
            success: function(e) {
                $(".btn-send-message").html("ارسال پاسخ"), $(".btn-send-message").prop("disabled", !1);
                var a = $.parseJSON(e),
                    t = '<div class="tiket_parent"><div class="icon-user"><i class="fa fa-user" aria-hidden="true"></i></div><div class="type-sender">کاربر</div><div class="panel-content">',
                    s = "<p><strong>" + a.name + '</strong><br><span class="fa-number" style="font-size: 12px;font-family: wyekan;color: #989898;">' + a.date + '</span> - <label class="fa-number" style="font-size: 12px;font-family: wyekan;color: #989898;">' + a.time_stamps + "</label></p>",
                    n = "<p>" + a.massage_send + "</p>";
                if ("" !== a.filename) var i = '<p><a id="file-' + a.id_file + '" onclick="download_file(\'' + a.id_file + "','" + a.filename + '\')" class="donwload-btn btn btn-xs btn-danger">[فایل ضمیمه] ' + a.file_size + " </a></p>";
                else i = "";
                "1" == a.check ? ($(".modal-backdrop").remove(), $("#show_models").removeClass("in"), $(".result_send_new").append(t + s + n + i + "</div>"), $("[name=f1]").val(""), $("#file_1").val(""), $("html, body").animate({
                    scrollTop: $(document).height()
                }, 1e3)) : show_massage(a.msg, "danger")
            }
        }), !1
    }
}
...
function track() {
    var e = $("[name=track_code]").val(),
        a = "1";
    "" == e && (show_massage("لطفا کد پیگیری را  وارد نمایید !", "danger"), a = "0"), "0" !== a && ($("#track_form").submit(), $(".btn-track").prop("disabled", !0), $(".btn-track").html('<i class="fa fa-1x fa-circle-o-notch fa-spin fa-fw margin-bottom"></i> صبر کنید '))
}

function EditMyPassword() {
    var e = $("[name=my_password]").val(),
        a = $("[name=password]").val(),
        t = $("[name=re-password]").val(),
        s = $("[name=CSRF_TOKEN]").val();
    $(".btn-chnage_pass").prop("disabled", !0), $(".btn-chnage_pass").html('<i class="fa fa-1x fa-circle-o-notch fa-spin fa-fw margin-bottom"></i> صبر کنید '), $.post("/?ajax=change_password", {
        my_pass: e,
        pass: a,
        re_pass: t,
        token: s
    }, function(e) {
        $(".btn-chnage_pass").prop("disabled", !1), $(".btn-chnage_pass").html("ویرایش رمز عبور"), "true" == e ? (show_massage("رمز عبور شما با موفقیت تغییر کرد", "success"), $("#EditPass").reset()) : show_massage(e, "danger")
    })
}

function EditMyprofile() {
    $(".btn_edit_profile").prop("disabled", !0), $(".btn_edit_profile").html('<i class="fa fa-1x fa-circle-o-notch fa-spin fa-fw margin-bottom"></i> صبر کنید ');
    var e = document.getElementById("frm_profile"),
        a = new FormData(e);
    $.ajax({
        ...
        type: "POST",
        success: function(e) {
            $(".btn_edit_profile").prop("disabled", !1), $(".btn_edit_profile").html("ویرایش اطلاعات کاربری"), "true" == e ? (show_massage("پروفایل شما بروزرسانی شد", "success"), $("#EditPass").reset()) : show_massage(e, "danger")
        }
    })
}

function register_user() {
    $(".register_btn").prop("disabled", !0), $(".register_btn").html('<i class="fa fa-1x fa-circle-o-notch fa-spin fa-fw margin-bottom"></i> صبر کنید ');
    var e = document.getElementById("register_user"),
        a = new FormData(e);
    $.ajax({
        ...
        type: "POST",
        success: function(e) {
            $(".register_btn").prop("disabled", !1), $(".register_btn").html("عضویت"), "true" == e ? (window.location = "/", $("#register_user").reset()) : show_massage(e, "danger")
        }
    })
}
var defaultSettings = "fa";
! function(e) {
    e.fn.persiaNumber = function(a) {
        function t(e, a) {
            e.find("*").andSelf().contents().each(function() {
                3 === this.nodeType && "style" != this.parentNode.localName && "script" != this.parentNode.localName && (this.nodeValue = this.nodeValue.replace(this.nodeValue.match(/[0-9]*\.[0-9]+/), function(e) {
                    ...
                    return String.fromCharCode(e.charCodeAt(0) + a)
                }))
            })
        }
        "string" == typeof a && a.length > 0 && (defaultSettings = a);
        var s = 1728;
        "ar" == a && (s = 1584), window.persiaNumberedDOM = this, t(this, s), e(document).ajaxComplete(function() {
    ...
    $("#featured").tabs({
        ...
        show: function(e, a) {
            ...
            var t = $(".info", a.panel).height();
            $(".info", a.panel).css("height", "0px").animate({
                height: t
            }, 500)
        }
    }).tabs("rotate", 5e3, !0), $("#featured").hover(function() {
        $("#featured").tabs("rotate", 0, !0)
    }, function() {
        $("#featured").tabs("rotate", 5e3, !0)
    }), $("#featured .ui-tabs-panel a.hideshow").click(function() {
        return "Hide" == $(this).text() ? ($(this).parent(".info").animate({
            height: "0px"
        }, 500), $(this).text("Show")) : ($(this).parent(".info").animate({
            height: "80px"
        }, 500), $(this).text("Hide")), !1
    })
}), $(document).ready(function() {
    $(".tab-header ol li a").click(function() {
        ...
        function(a, b) {
            ...
            a.formUtils = a.extend(a.formUtils || {}, {
                ...
                LANG: {
                    ...
                    requiredField: "فیلد ضروری میباشد",
                    ...
                    badUrl: "لطفا یک دامنه معتبر وارد نمایید",
