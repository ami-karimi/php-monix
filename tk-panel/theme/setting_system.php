   <section id="main-content">
     ...
     <section class="wrapper">
	    ...
	    <div class="col-lg-12">
         <section class="panel">
		 <form enctype="multipart/form-data" action="<?=MO_url(AdminTarget()."/setting_system");?>" method="POST">
		...
		<div class="panel-body">
	         ...
	         <div class="row">
                 ...
                 <div class="col-lg-6">
                     ...
                     <div class="form-group">
                         <label> آدرس پنل مدیریتی</label>
                         <input name="f100"  type="text" class="form-control" value="<?=se('admin_file_name');?>" placeholder="آدرس اختصاصی شما">
                         <span class="text-muted">آدرس اختصاصی پنل مدیریتی شما</span>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group col-lg-6">
                         <label>لوگو سایت</label></br>
                         <input type="file" name="logo_site" />
                     </div>
                     <div class="form-group col-lg-6">
                         <label>فاو آیکن</label></br>
                         <input type="file" name="fav_site" />
                     </div>
