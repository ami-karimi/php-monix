...
<div class="form-group">  
       ...
       <a href="#" onclick="confirm_box('آیا از حذف این کارمند اطمینان دارید؟','<?=Mo_url(AdminTarget().'/manage_Operator');?>?delete_id=8');" class="btn btn-danger  btn-sm"><i class="icon-trash"></i></a> 					  		  
                            </div>
                        </section>  
                    </div>
	</form>  
