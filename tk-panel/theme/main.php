                            ...
                            <div class="panel-body">
                              ...
                              <?php foreach($tiket as $row){?>
								 <tr>
								    ...
								    <td>   
									 <a onclick="confirm_box('ایا از حذف این درخواست اطمینان دارید؟ با حذف  تیکت تمامی  فایل ها و پیام های مربوط به این درخواست  حذف خواهد شد ','<?=MO_url(AdminTarget()."/manage_tiket");?>?delete_id=<?=$row['tk_code'];?>');"  href="#" class="btn btn-danger  btn-xs"><i class="icon-trash"></i></a>
