                              ...
                              <table class="table table-striped table-advance table-hover">
								...
								<?php foreach($data as $row){?>
								 <tr>
								    ...
								    <td>   
									 <a onclick="confirm_box('ایا از حذف این درخواست اطمینان دارید؟ با حذف  تیکت تمامی  فایل ها و پیام های مربوط به این درخواست  حذف خواهد شد ','<?=MO_url(AdminTarget()."/manage_tiket");?>?delete_id=<?=$row['tk_code'];?>');"  class="btn btn-danger  btn-xs" href="#"><i class="icon-trash"></i></a>
