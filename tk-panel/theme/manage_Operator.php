     ...
     <section class="wrapper">
		...
		<div class="panel-body">
									 ...
									 <form method="POST" class="form-inline" action="<?=Mo_url(AdminTarget().'/manage_Operator');?>" role="form">
								   <?php if(isset($text)){?> <div class="tags"><div style="margin-top: 1px;" onclick="window.location='<?=Mo_url(AdminTarget().'/manage_Operator');?>' " class="tag_remove"><i class="icon-remove"></i></div><label style="font-size: 13px;"><?php if($text){echo $text;}?></label></div> <?php }?>
                                ...
                                <tbody>  
                                 <?php foreach($data as $row){ ?>
                                   <tr>
                                      ...
                                      <td>
                                          <a onclick="confirm_box('آیا از حذف این کارمند اطمینان دارید؟','<?=Mo_url(AdminTarget().'/edit_Operator');?>?delete_id=<?=$row['id_am'];?>');" class="btn btn-danger  btn-xs"><i class="icon-trash"></i></a>
                                          <a class="btn btn-info  btn-xs" href="<?=Mo_url(AdminTarget().'/edit_Operator');?>?user_id=<?=$row['id_am'];?>"><i class="icon-pencil"></i></a>  
                                       </td>  
                                   </tr>
